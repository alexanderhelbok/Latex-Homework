...
%			
			\draw[MyRed, line width=1pt] (3.8, 0) -- (3.8, 2.4) node [above left, xshift=0.5cm] {2 qubit entanglement(2009)};
		\end{tikzpicture}
	\end{frame}
...
%	##################### Superconducting circuits #######################	
	\begin{frame}{Superconducting circuits}
		...
		\begin{textblock*}{5cm}(.8\textwidth,.2\textheight)
			\begin{circuitikz}[scale=1, transform shape]				
...
%				\node[below right] at (2.3, 1) {\( L_J \)};
		...
		\begin{textblock*}{5cm}(.8\textwidth,.6\textheight)
			\begin{tikzpicture}
				\begin{axis}[
					scale=0.775,
					width=\textwidth, height=4.5cm,
...
%		\centering
	...
	\begin{frame}{Outlook}
		\begin{tikzpicture}[scale=2.5, every node/.style={scale=0.8, black}]
			...
			%			
			\draw[MyBlue, line width=1pt] (0.9, 0) -- (0.9, .75) node [above left, xshift=0.2cm] {First SC qubit (1999)};
			
			\draw[MyBlue, line width=1pt] (1.4, 0) -- (1.4, 1.25) node [above left, align=left] {cQED (2004)};
			%			
			\draw[MyBlue, line width=1pt] (1.7, 0) -- (1.7, 1.25) node [above left, align=left] {Transmon (2007)};
			%			
			\draw[MyBlue, line width=1pt] (1.9, 0) -- (1.9, 2) node [above left, align=left] {2 qubit entanglement};
			%			
