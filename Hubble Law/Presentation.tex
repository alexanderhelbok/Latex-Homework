...
\begin{frame}{Frage 1}
	Warum habe ich \( H_0 \) immer Hubble Parameter und nicht Hubble Konstante (wie man es in vielen Publikationen sieht) genannt?
	\begin{itemize}
...
\begin{frame}{Frage 2}
	...
	\begin{itemize}
		...
		\only<2>{{\color{Green}\item[B)] Nein, weil ...}}
	\end{itemize}
\end{frame}
