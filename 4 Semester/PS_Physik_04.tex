...
\begin{mybox}{Magnetisches Moment von Kernen}
	...
	\tcbline
		\item \(  \)
		\begin{flalign*}
			\expval{\vec{j}^2}{j m_j} &= j(j+1) &&\\[2ex]
		...
		\end{flalign*}
		\begin{flalign*}
			g_{\text{Kern}} &= \frac{\expval{g_l \vec{j} \cdot \vec{l} + g_s \vec{s} \cdot \vec{j}}{j m_j}}{\expval{\vec{j}^2}{j m_j}} = &&\\[2ex]
	...
	\tcbline
		...
		\end{flalign*}
	\tcbline
		\item \( j = l \pm \tfrac{1}{2};\quad s = \tfrac{1}{2};\quad s(s+1) = \tfrac{3}{4};\quad j(j+1) = l^2 + 2l + \tfrac{3}{4} \)\\[3ex]
		Für \( j = l + \frac{1}{2}: \)
		\begin{flalign*}
		...
		\begin{flalign*}
			\frac{\Delta_{lsj}}{2j(j+1)} &= \frac{j(j+1) + s(s+1) - l(l+1)}{2j(j+1)}
				= \frac{l^2 - \tfrac{1}{4} + \tfrac{3}{4} - l^2 - l}{2l^2 - \tfrac{1}{2}} &&\\
			&= \frac{-l + \tfrac{1}{2}}{2l^2 - \tfrac{1}{2}} 
				= \frac{-l + \tfrac{1}{2}}{\left( -2l - 1 \right) \left( -l + \tfrac{1}{2} \right)} 
				= -\frac{1}{2l + 1} &&\\[4ex]
	...
	\tcbline
		\item \( g_l = \begin{cases}
					0 \quad &\text{für Neutronen} \\
					1 \quad &\text{für Protonen} \\
				\end{cases};\quad 
				g_s \approx \begin{cases}
					−3.8263 \quad &\text{für Neutronen} \\
					5.5858 \quad &\text{für Protonen} \\
				\end{cases} \)\\[2ex]
		Für \ch{^{17}O}: \\
		Leuchtnukleon ist Neutron
		\begin{flalign*}
			l &= 2; j = \tfrac{5}{2} &&\\[1ex]
			g_{\text{Kern}} &= g_l + \frac{(g_s - g_l)}{2l + 1} 
				= \frac{g_s}{5} 
				\approx -0.76526 &&\\[2ex]
			\frac{\mu_{\text{Kern}}}{\mu_{N}} &= g_{\text{Kern}}j 
				= \frac{5}{2} \frac{g_s}{5}  
				= \frac{g_s}{2} 
				\approx \dl{-1.91315} &&\\
		\end{flalign*}
		Passt gut mit dem experimentellen Wert von \( \frac{\mu_{\text{Kern}}}{\mu_{N}} = −1.894 \) zusammen. 
	\newpage
		Für \ch{^{17}F}: \\
		Leuchtnukleon ist Proton
		\begin{flalign*}
			l &= 2; j = \tfrac{5}{2} &&\\[1ex]
			g_{\text{Kern}} &= g_l + \frac{(g_s - g_l)}{2l + 1} 
				= 1 + \frac{g_s - 1}{5} 
				\approx 1.91716 &&\\[2ex]
			\frac{\mu_{\text{Kern}}}{\mu_{N}} &= g_{\text{Kern}}j 
				= \frac{5}{2} \left( 1 + \frac{g_s - 1}{5} \right)
				= \frac{4 + g_s}{2} 
				\approx \dl{4.7929} &&\\
		\end{flalign*}
		Passt gut mit dem experimentellen Wert von \( \frac{\mu_{\text{Kern}}}{\mu_{N}} = 4.793 \) zusammen. 
	\end{enumerate}
\end{mybox}
