...
\begin{document}
	...
	\begin{mybox}{Kernspaltung - “Little Boy”}
		\begin{enumerate}
			\item \ch{^{236}U} ist zwar ein recht stabiler Kern, bei der Spaltung von \ch{^{235}U} entsteht aber \ch{^{236}U^*} als Zwischenprodukt. Dessen Kern befindet sich in einem angeregten Zustand, der dann zur Spaltung führt.
		\tcbline
			\item \(  \)
			\begin{flalign*}
	...
	\begin{mybox}{Energiebilanz der Sonne}
		...
		\tcbline
			...
			\begin{flalign*}
				P_{\text{ges}} &= P_{\text{Erde}}\tfrac{4d^2\pi}{A}
					= E_0 4d^2\pi
					= \dl{3.83 \cdot 10^{26} \unit{W}} &&
			\end{flalign*}
		\tcbline	
			\item \(  \)
			\begin{flalign*}
