...
\begin{mybox}{Zentraler relativistischer Stoß und Bethe-Bloch-Formel}
	...
	\begin{enumerate}
		...
		\begin{flalign*}
			...
			\Pp[\mu][2f] &= \Lambda_{\nu'}^{\mu}\Pp[\nu'][2f]
			= (\tilde{\gamma}^2\me + \tilde{\beta}^2\tilde{\gamma}^2\me, \tilde{\beta}\tilde{\gamma}^2\me + \tilde{\beta}\tilde{\gamma}^2\me) &&\\[3ex]
...
\begin{mybox}{Das Mesonen-Nonett}
	...
	\begin{enumerate}
		...
		\end{flalign*}
	\tcbline
		\item \( \psi_2 = N_2(\ket{u\bar{u}} \pm \ket{d\bar{d}});\quad N_2 = \tfrac{1}{\sqrt{2}} \)
		\begin{flalign*}
