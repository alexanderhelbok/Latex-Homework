...
\begin{mybox}{Zentraler relativistischer Stoß und Bethe-Bloch-Formel}
	\centering \( \Pp[\mu][i] \dots \) LS, vor dem Stoß, \(\qquad \Pp[\mu][f] \dots \) LS, nach dem Stoß \\
				\( \Pp[\nu'][i] \dots \) CMS, vor dem Stoß, \(\qquad \Pp[\nu'][f] \dots \) CMS, nach dem Stoß
	\tcblower
	\begin{enumerate}
		\item \( \Pp[\mu][i] = (\me, \vec{0}) ;\quad \tilde{\beta} = \tfrac{p}{E} = \tfrac{p_1}{E_1 + \me} = \tfrac{\gamma\beta M}{\gamma M + \me} \)
		\begin{flalign*}
			\Pp[\nu'][i] &= \Lambda_{\mu}^{\nu'}\Pp[\mu][i]
				= (\tilde{\gamma}\me, -\tilde{\beta}\tilde{\gamma}\me) &&\\
			\Pp[\nu'][f] &= (\tilde{\gamma}\me, \tilde{\beta}\tilde{\gamma}\me) &&\\
			\Pp[\mu][f] &= \Lambda_{\nu'}^{\mu}\Pp[\nu'][f]
...
%			
			T &= \tilde{\gamma}^2\me + \tilde{\beta}^2\tilde{\gamma}^2\me - \me 
				...
				= 2\me \tfrac{\tilde{\beta}^2}{1 - \tilde{\beta}^2} &&\\
