...
%		\vec{B}(z) &= \dl{\tfrac{\mu_0I}{4}\vector{R^2 / \left( x^2+y^2+z^2 \right)^{3/2}\\ 0\\ \tfrac{Rz}{\left( x^2 + y^2 + z^2 \right)^{3/2}} + \tfrac{2z}{\pi\sqrt{y^2 + z^2}\sqrt{x^2+y^2+z^2}}}} &&
%	\end{flalign*}
%\end{mybox}
...
\begin{mybox}{3. Drehmoment auf rechteckige Leiterschleife}
	...
	\begin{enumerate}
		...
		\begin{flalign*}
			...
			\vec{M} &= \vec{M}_1 + \vec{M}_2 = \tfrac{\mu_0I_1I_2hd}{2r\pi}\vector{0\\ 0\\ \cos(\varphi)} &&\\
		\end{flalign*}
	\tcbline
