...
\begin{mybox}{3. Elektrische Verschiebung}
	...
	\tcbline
		\item \(  \)
		\begin{flalign*}
			C &= \tfrac{1}{\tfrac{a}{A\epsilon_1} + \tfrac{a}{A\epsilon_2}} = \tfrac{A\epsilon_1\epsilon_2}{a(\epsilon_1 + \epsilon_2)} &&\\
			U &= \tfrac{Q}{C} = \dl{\sigma \tfrac{a(\epsilon_1 + \epsilon_2)}{\epsilon_1\epsilon_2}} &&
		\end{flalign*}
	\tcbline
		\item \(  \)
%		\begin{flalign*}
...
%		\end{flalign*}
	\tcbline
		\item \(  \)
		\begin{flalign*}
			U &= \abs*{E}2a = \dl{\sigma \tfrac{a(\epsilon_1 + \epsilon_2)}{\epsilon_1\epsilon_2}} &&	
		\end{flalign*}
	\end{enumerate}
\end{mybox}
