...
\begin{mybox}{3. Stehende Wellen}
	...
	\tcbline
		...
		\begin{flalign*}
			\vec{E}_1(\hat{x}, t) &=  \Re\left( \vec{E}_0\, \mathrm{e}^{\iu\vec{k}\hat{x} - \iu\omega t} \right) &&\\
			\vec{E}_2(\hat{y}, t) &=  \Re\left( \vec{E}_0\, \mathrm{e}^{\iu\vec{k}\hat{y} - \iu\omega t} \right) &&\\
			\vec{E} &= \vec{E}_1 + \vec{E}_2 = \Re\left( \vec{E}_0\, \mathrm{e}^{\iu\vec{k}\hat{y} - \iu\omega t} + \mathrm{e}^{-\iu\vec{k}\hat{x} - \iu\omega t} \right) &&\\
		\end{flalign*}
	\tcbline
		\item \(  \)
%		\begin{flalign*}
...
%		\end{flalign*}
	\tcbline
		...
		\begin{flalign*}
			\vec{E}_1(\hat{x}, t) &=  \Re\left( \vec{E}_0\, \mathrm{e}^{\iu\vec{k}\hat{x} - \iu\omega_1 t} \right) &&\\
			\vec{E}_2(-\hat{x}, t) &=  \Re\left( \vec{E}_0\, \mathrm{e}^{-\iu\vec{k}\hat{x} - \iu\omega_2 t} \right) &&\\
			\vec{E} &= \vec{E}_1 + \vec{E}_2 = \Re\left( \vec{E}_0\, \mathrm{e}^{\iu\vec{k}\hat{x} - \iu2\omega_2	 t} + \mathrm{e}^{-\iu\vec{k}\hat{x} - \iu\omega_2 t} \right) &&\\
		\end{flalign*}´
	\end{enumerate}
\end{mybox}
