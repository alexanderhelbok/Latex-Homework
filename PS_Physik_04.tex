...
%					tick label style={font=\tiny},
	...
	\begin{enumerate}
		...
		\item
		\begin{flalign*}
			\vec{a}(t) &= \dl{\overbrace{2R\gamma\ \vector{-\sin\gamma t^2\\ \cos\gamma t^2}}^\text{Tangentialbeschleunigung} + \overbrace{4R\gamma^2t^2 \vector{-\cos\gamma t^2\\ -\sin\gamma t^2}}^\text{Zentripetalbeschleunigung}} &&\\[1em]
			...
			\left|a(t)\right| &= \sqrt{\underbrace{4R^2\gamma^2}_\text{Tangentialbeschl.} + \underbrace{16R^2\gamma^4 t^4}_\text{Zentripetalbeschl.}} &&\\
		\end{flalign*}
		\item 
		\begin{multicols}{2}
			\begin{align*}
