...
\section*{177. Stabpendel mit Kugeln}
	...
	\item \( I_{ges} = I_{Stab} + I_{Kugel_{1}} + I_{Kugel_{2}} \)	
		\begin{flalign*}
			...
			I_{Kugel_{1}} &= \tfrac{2}{5}m_1r_1\!^2 + m_1(\tfrac{L}{2}+r_1)^2 = 4.0*10^{-3} \unit{kg.m^2} &&\\
			I_{Kugel_{2}} &= \tfrac{2}{5}m_2r_2\!^2 + m_2(\tfrac{L}{2}+r_2)^2 = 1.4*10^{-2} \unit{kg.m^2} &&\\[2ex]
			\Rightarrow I_{ges} &= \dl{2 * 1o^{-2} \unit{kg.m^2}} &&
		\end{flalign*}
	\item 
		\begin{flalign*}
