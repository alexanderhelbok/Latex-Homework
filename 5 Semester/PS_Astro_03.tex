...
\begin{mybox}{the thermal history of the universe}
	\begin{enumerate}[label=\arabic*)]
		...
		\begin{enumerate}
			\item Elementary particles are at equilibrium when the rate at which they are created and destroyed are equal.
			...
			\item The neutrino freeze out means, that reactions involving neutrinos become rare and therefore the existing neutrinos decouple from the evolution of the rest of the universe.
