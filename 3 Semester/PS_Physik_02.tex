...
\begin{mybox}{Bestimmung des Wirkungsquerschnitts}
	...
	\tcbline
		\item Instead of only varying the thickness of the medium, it is easier to change the pressure because in order to change the thickness you have to . When varying the distance in one plane you have to keep the molecules from escaping in other directions, which is pretty hard using electrically neutral molecules. \\
		\begin{flalign*}
			I(p) &= I_0\expo[-][\beta p] &&\\
