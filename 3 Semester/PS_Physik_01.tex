...
\begin{mybox}{Ebene Wellen und Kugelwellen}
	...
	\begin{enumerate}
		\item \(  \)
		\begin{flalign*}
			A_1(x, t) &= \tikzmark{1}\ A_0\ \tikzmark{2} \cos(kx - \omega t) &&	
		\end{flalign*}
		The Amplitude of the wave, denoted \( A_0 \), in case of water waves this tells us how high the wave can get (in respect to still water) and in respect to sound 
	...
	\tcbline
		\item \(  \)
		\begin{flalign*}
			A_1(x, t) &= A_0 \cos(kx - \omega t) = A_0 \expo[ikx - i\omega t] &&\\
			A_2(r, \theta, \varphi) &= A_0 \cos(kr - \omega t) = A_0 \expo[ikr - i\omega t] &&\\
		\end{flalign*}
	\end{enumerate}
\end{mybox}
